                ...
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="m-3 p-4">
                        ...
                        <h4 class="text-dark font-weight-normal">Welcome to <span
                                class="font-weight-bold">Cashier</span>
                        </h4>
                        <p class="text-muted">Before you get started, you must login or register to admin if you don't
                            already
                            have an account.</p>
                        <form method="POST" action="{{ route('login') }}" class="needs-validation">
                            ...
                            <div class="mt-5 text-center">
                                Don't have an account? <a href="auth-register.html">Ask Admin xd</a>
                            </div>
                        </form>

                        <div class="text-small mt-5 text-center">
                            Copyright &copy; Your Company. Made with 💙 by Shaq
                            <div class="mt-2">
                    ...
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                ...
                                <h5 class="font-weight-normal text-muted-transparent">Makassar, Indonesia</h5>
                            </div>
